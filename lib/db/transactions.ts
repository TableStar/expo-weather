...
export async function seedMockData() {
  ...
  const mockTrans = [
    ...
    { type: 'out' as const, amount: 50000.05, notes: 'Bensin', date: daysAgo(1), time: '07:45' },
    { type: 'in' as const, amount: 150000.5, notes: 'Jual barang', date: daysAgo(1), time: '14:00' },
    { type: 'out' as const, amount: 35000.12, notes: 'Beli pulsa', date: daysAgo(2), time: '10:00' },
    ...
    { type: 'in' as const, amount: 500000.12, notes: 'Freelance', date: daysAgo(2), time: '16:00' },
    { type: 'out' as const, amount: 30000.34, notes: 'Parkir mall', date: daysAgo(3), time: '13:00' },
    { type: 'in' as const, amount: 100000.23, notes: 'Refund', date: daysAgo(3), time: '11:00' },
